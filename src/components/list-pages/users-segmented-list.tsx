...
export function UsersSegmentedList() {
        ...
        <div className="flex flex-col gap-5 p-4 sm:p-5">
          <div className="min-w-0 space-y-1">
            ...
            <p className="text-muted-foreground max-w-xl text-sm">
              Track and manage all user accounts across your workspace.
            </p>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div
              ...
              className="bg-muted inline-flex w-fit max-w-full items-center gap-0.5 overflow-x-auto rounded-full p-1"
            >
              {statusTabs.map((tab) => {
            ...
            <div className="flex w-full items-center gap-2 sm:w-auto">
              <div className="relative min-w-0 flex-1 sm:w-56 sm:flex-none">
                ...
                <Input
                  ...
                  placeholder="Search"
                  className={cn(
                    "h-9 rounded-full bg-muted/50 pl-9 shadow-none",
                    query && "pr-8"
                  )}
                />
                {query ? (
                  <button
                    ...
                    onClick={() => setQuery("")}
                    className="text-muted-foreground hover:text-foreground absolute top-1/2 right-2.5 inline-flex size-5 -translate-y-1/2 cursor-pointer items-center justify-center rounded-sm"
                  >
